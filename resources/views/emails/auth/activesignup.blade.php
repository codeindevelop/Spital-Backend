            ...
            <tr>
                <td class="sm-p-6"
                    ...
                    <p style="margin: 0 0 24px; font-size: 16px; line-height: 24px; color: #475569">
                       با تشکر از صرف وقت برای تایید ایمیل ، به اطلاع شما میرسانیم که ایمیل شما با اطلاعات زیر تایید شده و دسترسی های لازم برای شما اعمال گردید .
                    </p>
                    <div style="display: flex; width: 100%; flex-direction: column; color: #475569">
                        <p>ادرس ای پی : {{ $ip }}  </p>
                        <p>تاریخ تایید ایمیل : {{ $date }}</p>
                        <p>ساعت تایید ایمیل : {{ $time }}</p>
                    </div>
