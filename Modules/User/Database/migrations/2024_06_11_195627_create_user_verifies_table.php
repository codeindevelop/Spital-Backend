...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('user_verifies', function (Blueprint $table) {
            ...
            $table->string('shenasname_number')->nullable();
            $table->string('mellicard_number')->nullable();
            $table->string('mellicard_back_number')->nullable();
            $table->string('atbaa_number')->nullable(); // madarke atbaa afghani
            ...
            $table->text('passport_document')->nullable();
