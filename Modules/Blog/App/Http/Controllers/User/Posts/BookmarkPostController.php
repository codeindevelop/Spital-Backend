...
use Modules\Blog\App\Services\Posts\BookmarkPostService;
use Symfony\Component\HttpFoundation\Response;

class BookmarkPostController extends Controller
{
    protected BookmarkPostService $postService;

    public function __construct(BookmarkPostService $postService)
    {
