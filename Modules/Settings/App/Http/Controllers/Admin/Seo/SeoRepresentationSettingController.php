...
class SeoRepresentationSettingController extends Controller
{
    ...
    public function updateSettings(Request $request): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'social_telegram' => ['nullable', 'max:255'],
            'social_tiktok' => ['nullable', 'max:255'],
            'social_snapchat' => ['nullable', 'max:255'],
            'social_threads' => ['nullable', 'max:255'],
            'social_github' => ['nullable', 'max:255'],
            'social_linkedin' => ['nullable', 'max:255'],
            'social_pinterest' => ['nullable', 'max:255'],
            'social_wikipedia' => ['nullable', 'max:255'],
        ]);
